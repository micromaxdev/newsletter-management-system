...
//                 <p style={{ fontSize: '14px', color: '#666', margin: '0' }}>Total Authorized</p>
//                 <p style={{ fontSize: '2rem', fontWeight: 'bold', margin: '0' }}>{authorizedEmails.length}</p>
//               </div>
//             </div>
//           </div>
...
//               </div>
//               <div style={{ marginLeft: '1rem' }}>
//                 <p style={{ fontSize: '14px', color: '#666', margin: '0' }}>Active Emails</p>
//                 <p style={{ fontSize: '2rem', fontWeight: 'bold', margin: '0' }}>
//                   {authorizedEmails.filter(email => email.status === 'active').length}
//                 </p>
//               </div>
//             </div>
//           </div>
...
//                 <X size={24} color="#d97706" />
//               </div>
//               <div style={{ marginLeft: '1rem' }}>
//                 <p style={{ fontSize: '14px', color: '#666', margin: '0' }}>Inactive Emails</p>
//                 <p style={{ fontSize: '2rem', fontWeight: 'bold', margin: '0' }}>
//                   {authorizedEmails.filter(email => email.status === 'inactive').length}
//                 </p>
//               </div>
//             </div>
//           </div>
...
//           marginBottom: '2rem'
//         }}>
//           <h2 style={{ fontSize: '1.2rem', fontWeight: '600', margin: '0 0 1rem' }}>Add New Authorized Email</h2>
