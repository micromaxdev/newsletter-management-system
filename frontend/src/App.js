    ...
    >
      ...
      <div
        ...
        style={{
          ...
          cursor: "pointer",
          backgroundColor:
            selectedFolder === "subscribed" ? "#e0e7ff" : "transparent",
          borderRadius: "6px",
          margin: "4px 0",
      ...
      {folders.map((folder) => (
        ...
        >
          ...
          <button
            ...
            style={{
              backgroundColor: isSubscribedToFolder(folder.id)
                ? "#059669"
                : "#10b981",
              color: "white",
              border: "none",
            ...
            onMouseLeave={(e) => {
              e.target.style.backgroundColor = isSubscribedToFolder(folder.id)
                ? "#059669"
                : "#10b981";
            }}
            title={
              isSubscribedToFolder(folder.id)
...
function App() {
  ...
  const handleSubscribe = async (folderId) => {
    try {
      const folderName =
        folderConfig.find((f) => f.id === folderId)?.name || "Unknown";
  ...
  return (
    ...
    >
      ...
      {/* Subscription Modal - Updated position */}
