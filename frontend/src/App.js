...
//         >
//           {/*
//             User Story: "As a user, I want inline images and rich HTML rendered safely so newsletters look the way publishers designed them."
//             To disable this user story's functionality, we'll comment out the rendering of the email's HTML content.
//             This prevents rich formatting and inline images from being displayed.
//             Uncomment the block below to re-enable rich HTML rendering.
//           */}
//           {
//             email.html ? (
//               <div dangerouslySetInnerHTML={{ __html: email.html }} />
...
//             ) : (
//               <p style={{ fontSize: "1rem", color: "#64748b", textAlign: "center", padding: "2rem" }}>
//                 HTML rendering is currently disabled. No readable content (text or HTML) for this email.
//               </p>
//             )
//           }
//         </div>
...
//   // ✅ Inline image replacement: cid:image001.png@... => <img src="data:..." />
//   const getSanitizedHtmlWithInlineImages = () => {
//     let sanitized = email.html || "";
...
//           sanitized = sanitized.replace(cidRegex, dataUri);
//         }
//       });
//     }
...
//         }}
//       >
//         {/* Header with navigation, subject, folder select, close */}
//         {/* ... same as before ... */}

//         {/* Sender/Date/Folder Row */}
//         {/* ... same as before ... */}
...
//                 __html: getSanitizedHtmlWithInlineImages(),
//               }}
//             />
//           ) : email.text ? (
//             <p
...
const EmailModal = ({ email, onClose, folderConfig, onMoveEmail, displayedEmails, onSelectEmail, onMarkAsRead }) => {
  ...
  const sanitizedHTML = email.html ? DOMPurify.sanitize(email.html, { ADD_ATTR: ["target"] }) : "";
    ...
    >
      <div
        style={{
          backgroundColor: "white",
          borderRadius: "12px",
          maxWidth: "900px", width: "90%", maxHeight: "90vh",
          overflow: "hidden",
          position: "relative",
      ...
      >
        ...
        <div style={{
          ...
          marginBottom: "1.5rem", borderBottom: "1px solid #e2e8f0",
          paddingBottom: "1rem"
        }}>
